...
\end{center}
\caption[Multi-agent diverse GAN]{Multi-agent diverse GAN \cite{ghosh2018multi}. Given an input noise vector $z$, the network which is shared among all generators produces an intermediate representation. From this representation, each generator outputs a sample. The discriminator is a }
\vskip\baselineskip
