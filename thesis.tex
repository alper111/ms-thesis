...
\begin{center}
\subfloat[MNIST]{
	\includegraphics[width=0.5\linewidth]{samples_mnist.png}
	\label{fig:samples:mnist}
}
\subfloat[FashionMNIST]{
	\includegraphics[width=0.5\linewidth]{samples_fashion.png}
	\label{fig:samples:fashion}
}

\subfloat[CelebA]{
	\includegraphics[width=0.5\linewidth]{samples_celeb.png}
	\label{fig:samples:celeb}
}
\subfloat[UTZap50K]{
	\includegraphics[width=0.5\linewidth]{samples_utzap50k.png}
	\label{fig:samples:utzap50k}
}

\subfloat[Oxford Flowers]{
	\includegraphics[width=0.5\linewidth]{samples_flowers.png}
	\label{fig:samples:flowers}
}
\end{center}
\caption{Samples generated using our proposed HME-6 model.}
\vskip\baselineskip
\label{fig:samples}
\end{figure}
...
Some generated examples for different data sets using the hierarchical mixture model are shown in Figure \ref{fig:samples}. It can be seen that these are quite realistic and contain diversity.
...
**explain Figure \ref{fig:covariances}.**
...
\hline
\multirow{3}{*}{\rotatebox{90}{UTZap50K}}
& \rotatebox{90}{Real} & x & $86.83 \pm 1.12$ & $86.97 \pm 0.54$ & x \\
\cline{2-6}
& \rotatebox{90}{Fake} & x & $77.25 \pm 1.53$ & $77.50 \pm 1.13$ & x \\
\cline{2-6}
& \rotatebox{90}{FID} & x & $41.95 \pm 2.82$ & $41.45 \pm 1.99$ & x \\
\hline
\multicolumn{2}{|c|}{params.} & 3.30M & 6.61M & 13.23M & 26.47M \\
\hline
\multirow{3}{*}{\rotatebox{90}{Flowers}}
& \rotatebox{90}{Real} & x & $88.59 \pm 1.43$ & $89.33 \pm 1.39$ & x \\
\cline{2-6}
& \rotatebox{90}{Fake} & x & $96.79 \pm 0.69$ & $96.93 \pm 0.36$ & x \\
\cline{2-6}
& \rotatebox{90}{FID} & x & $113.37 \pm 3.92$ & $115.45 \pm 3.02$ & x \\
\hline
\multicolumn{2}{|c|}{params.} & 3.30M & 6.61M & 13.23M & 26.47M \\
\hline
\end{tabular}
...
\hline
\multirow{3}{*}{\rotatebox{90}{Fashion}}
& \rotatebox{90}{Real} & x & x & x & $75.01 \pm 0.20$ \\
\cline{2-6}
& \rotatebox{90}{Fake} & x & x & x & $84.89 \pm 0.39$ \\
\cline{2-6}
& \rotatebox{90}{FID} & x & x & x & $26.50 \pm 0.63$ \\
\hline
\multicolumn{2}{|c|}{params.} & 20K & 135K & 266K & 413K \\
\hline
\multirow{3}{*}{\rotatebox{90}{CelebA}}
