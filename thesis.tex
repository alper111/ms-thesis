...
\end{center}
\caption[Multi-agent diverse GAN]{Multi-agent diverse GAN \cite{ghosh2018multi}. Given an input noise vector $z$, the shared network produces an intermediate representation. From this representation, each generator outputs a sample. The discriminator makes a $K+1$-class classification, one class for the real sample, and the other $K$ classes for the index of the generator.}
\vskip\baselineskip
...
\end{center}
\caption[Mixture of experts GAN]{Mixture of experts GAN \cite{park2018megan}.}
\vskip\baselineskip
