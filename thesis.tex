...
\begin{center}
\subfloat[MNIST]{
	\includegraphics[width=0.8\linewidth]{mnist_dataset.png}
	\label{fig:samples:mnist}
}

\subfloat[FashionMNIST]{
	\includegraphics[width=0.8\linewidth]{fashion_dataset.png}
	\label{fig:samples:fashion}
}

\subfloat[CelebA]{
	\includegraphics[width=0.8\linewidth]{celeba_dataset.png}
	\label{fig:samples:celeba}
}

\subfloat[UTZap50K]{
	\includegraphics[width=0.8\linewidth]{utzap50k_dataset.png}
	\label{fig:samples:shoes}
}

\subfloat[UTZap50K]{
	\includegraphics[width=0.8\linewidth]{flowers_dataset.png}
	\label{fig:samples:shoes}
}
\end{center}
